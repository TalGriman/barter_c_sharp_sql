...
namespace barter.Data
{
    public class DbConnection
    {
        ...
        public DbConnection()
        {
            bool localWebApi = false; // for bublish false
            bool sqlLocal = false; // for bublish false
            ...
            {
                connectionString = ConfigurationManager.ConnectionStrings["LIVEDNSfromLocal"].ConnectionString;
            }
            else
            {
                connectionString = ConfigurationManager.ConnectionStrings["LIVEDNSfromLivedns"].ConnectionString;
            }
        }
